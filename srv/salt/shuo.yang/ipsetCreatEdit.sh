...
iptables -A INPUT -m set --match-set CDN_SourceSite src -m conntrack --ctstate NEW -j ACCEPT 
iptables -A INPUT -m set --match-set MoniAutomana src -m conntrack --ctstate NEW -j ACCEPT 
iptables -A INPUT -m set --match-set StepTread src -m conntrack --ctstate NEW -j ACCEPT 
iptables -A INPUT -d 239.2.11.71/32 -j ACCEPT 
iptables -A INPUT -m set --match-set Intranet src -m conntrack --ctstate NEW -j ACCEPT 
iptables -A INPUT -i lo -j ACCEPT 
iptables -A INPUT -m set --match-set Ipadapter src -m conntrack --ctstate NEW -j ACCEPT 
iptables -A INPUT -m set --match-set DBmongo_distributed src -m conntrack --ctstate NEW -j ACCEPT 
#me end
